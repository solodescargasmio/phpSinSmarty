...
<body>
   ...
   <a href="nuevaVersion.php" > <button id="ver"  class="btn btn-primary btn-group-sm">Nueva Version</button></a> 
    ...
    require_once ('./clases/estudio_medico.php');
       ...
       <tr class="version1">
    <td class="formu"><a style="cursor:pointer;"><input type="text" id="nom_formu" class="formu" value="<?php echo $formulario->getNombre();?>" hidden=""><?php echo $formulario->getNombre(); ?></a></td>                 
                   </tr>
          <?php   
          }} ?>
